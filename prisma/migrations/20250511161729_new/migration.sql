...
-- CreateEnum
CREATE TYPE "FeedbackEntityType" AS ENUM ('ANALYSIS_RESULT', 'NAME_SUGGESTION', 'TASK_SUGGESTION', 'GITHUB_AI_ACTION', 'DELIVERABLE', 'PITCH_DECK_CONTENT', 'PLATFORM_FEATURE', 'GENERAL');
